...
type FragnanceDocumentDataSlicesSlice = never;

/**
 * Content for Fragnance documents
 */
interface FragnanceDocumentData {
  /**
   * Title field in *Fragnance*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.title
   * - **Tab**: Main
  ...
  /**
   * Bottle Image field in *Fragnance*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.bottle_image
   * - **Tab**: Main
  ...
  /**
   * Feature Image field in *Fragnance*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.feature_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  ...
  /**
   * Description field in *Fragnance*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.description
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  ...
  /**
   * Price field in *Fragnance*
   *
   * - **Field Type**: Number
   * - **Placeholder**: (In Rs)
   * - **API ID Path**: fragnance.price
   * - **Tab**: Main
  ...
  /**
   * Scent Profile field in *Fragnance*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: spicy
   * - **API ID Path**: fragnance.scent_profile
   * - **Tab**: Main
  ...
  /**
   * Mood field in *Fragnance*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.mood
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  mood: prismic.SelectField<"bold" | "grounded" | "refresh">;

  /**
   * Slice Zone field in *Fragnance*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/slices
   */
  slices: prismic.SliceZone<FragnanceDocumentDataSlicesSlice> /**
   * Meta Image field in *Fragnance*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/fields/image
   */;
...
/**
 * Fragnance document from Prismic
 *
 * - **API ID**: `fragnance`
 * - **Repeatable**: `true`
 ...
 */
export type FragnanceDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<FragnanceDocumentData>,
    "fragnance",
    Lang
  >;
...
/**
 * Item in *FragnanceList → Default → Primary → Fragrances*
 */
export interface FragnanceListSliceDefaultPrimaryFragrancesItem {
  /**
   * Fragrance field in *FragnanceList → Default → Primary → Fragrances*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance_list.default.primary.fragrances[].fragrance
   * - **Documentation**: https://prismic.io/docs/fields/content-relationship
   */
  fragrance: prismic.ContentRelationshipField<"fragnance">;
}

/**
 * Primary content in *FragnanceList → Default → Primary*
 */
export interface FragnanceListSliceDefaultPrimary {
  /**
   * Eyebrow field in *FragnanceList → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance_list.default.primary.eyebrow
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  eyebrow: prismic.KeyTextField;

  /**
   * Heading field in *FragnanceList → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance_list.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *FragnanceList → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance_list.default.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Fragrances field in *FragnanceList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: fragnance_list.default.primary.fragrances[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  fragrances: prismic.GroupField<
    Simplify<FragnanceListSliceDefaultPrimaryFragrancesItem>
  >;
}
...
export type FragnanceListSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<FragnanceListSliceDefaultPrimary>,
  never
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      FragnanceDocument,
      FragnanceDocumentData,
      FragnanceDocumentDataSlicesSlice,
      HomepageDocument,
      HomepageDocumentData,
      HomepageDocumentDataSlicesSlice,
      AllDocumentTypes,
      FragnanceListSlice,
      FragnanceListSliceDefaultPrimaryFragrancesItem,
      FragnanceListSliceDefaultPrimary,
      FragnanceListSliceVariation,
